...
# Creates a virtual environment for perceptual model project computations.
...
# Equally effective according to Chris, but preserves cache, is:
gdal_str="python3 -m pip install --no-cache-dir -v --force-reinstall gdal[numpy]==${gdal_version}"
eval $gdal_str
